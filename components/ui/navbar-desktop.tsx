  ...
  return (
    <div className="hidden md:flex items-center gap-10 text-sm font-medium text-white/70">
      ...
      <a
        ...
        className="px-6 py-2.5 text-xs font-bold tracking-widest text-deep-void bg-holographic rounded-full hover:bg-white transition-all hover:scale-105 active:scale-95 uppercase flex items-center gap-2 shadow-[0_0_20px_rgba(102,252,241,0.3)] hover:shadow-[0_0_30px_rgba(102,252,241,0.5)]"
      >
        {navbar.cta}
      </a>
    </div>
