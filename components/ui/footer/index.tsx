        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-24 mb-8 md:mb-16">
          <div className="space-y-8">
            <h2 className="text-4xl md:text-6xl font-bold tracking-tighter text-light-fg dark:text-white">
              {footer.title.split("\n")[0]} <br />
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-light-primary to-light-primary/60 dark:from-holographic dark:to-white">
            ...
            <div className="space-y-4">
              <a
                ...
                className="block text-xl md:text-2xl text-light-fg dark:text-white hover:text-light-primary dark:hover:text-holographic transition-colors"
              >
                {footer.email}
              </a>
              <p className="text-light-muted dark:text-white/60">
                {footer.phone}
              </p>
              <div className="flex items-center gap-2">
                <div className="w-2 h-2 rounded-full bg-green-500 animate-pulse" />
                <p className="text-light-fg dark:text-white">
                  {footer.address}
                </p>
              </div>
            </div>
