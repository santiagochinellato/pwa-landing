...
export default function StackSection() {
  ...
  return (
    <section className="py-24 bg-gradient-to-b from-light-bg to-white dark:from-deep-void dark:to-deep-void px-6 md:px-12 relative border-t border-light-border dark:border-white/5 transition-colors duration-300">
